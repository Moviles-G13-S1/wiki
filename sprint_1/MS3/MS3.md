...
| 3 | Andrea | Andrea is a independent young woman that already works and lives alone. She enjoys shopping online more than in person, and she enjoys saving money on new items she hadn't noticed before. | *(add path once created)* | *(add link once created)* | *(add team member)* |

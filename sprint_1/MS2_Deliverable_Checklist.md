...
| | |
|---|---|
| **Deadline** | August 15th, 2026, 5:00 am |
| **Deliverable format** | GitHub Wiki page titled **"MS2"** — submit the wiki URL via Bloque Neón |
| **Accepted format** | Markdown only. PDF, Word, and Google Docs submissions will **not** be accepted |
| **Possible points** | 10 points |

> **Timestamp warning:** GitHub records edit timestamps in GMT (UTC+0), while course deadlines are given in GMT-5. Do not edit your wiki page after the deadline — submissions edited late will receive a grade of **0**.
...
- Every team member must conduct **at least one interview** using the techniques from **MS2-C1**.
  - Team of 6 → ≥ 6 interviews
  - Team of 5 → ≥ 5 interviews
  - Team of 4 → ≥ 4 interviews
  - Team of 3 → ≥ 3 interviews (scale accordingly)
- Interviews can center on the same problem/domain or explore different ones (exploring different problems is recommended for flexibility later).
...
- Suggested reading:
  - Lim, Y. K., Stolterman, E., & Tenenberg, J. (2008). *The Anatomy of Prototypes: Prototypes as Filters, Prototypes as Manifestations of Design Ideas.* ACM TOCHI, 15(2), 1–27. https://doi.org/10.1145/1375761.1375762
  - [ProtoPie — Low Fidelity vs. High Fidelity Prototyping](https://www.protopie.io/blog/low-fidelity-vs-high-fidelity-prototyping)

---

## Submission

Submit the link to your GitHub Wiki through the corresponding deliverable entry in Bloque Neón **before the deadline**. The wiki content must be written in **Markdown** — no other formats are accepted.

## Quality Expectations

- **Clear visuals:** legible images with sufficient resolution.
- **Consistency:** uniform formatting for headings, figures, and tables throughout.
- **Implementation:** apply concepts from lectures, labs, and course materials as instructed for each resource.
